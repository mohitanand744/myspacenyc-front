...
import { FeaturedListingData } from "@/data/properties";
// import "@/app/globals.scss";

export default function FeaturedListing({
  parentClass = "tf-spacing-1 section-categories",
}) {
  const [activeItem, setActiveItem] = useState("All Property");
  const [filtered, setFiltered] = useState(FeaturedListingData);
  const items = [
    { name: "All Property", listings: "10 Listing" },
    { name: "House", listings: "9 Listing" },
    { name: "Rent", listings: "10 Listing" },
    { name: "Apartment", listings: "20 Listing" },
    { name: "Sale", listings: "9 Listing" },
  ];
  useEffect(() => {
    setFiltered(
      FeaturedListingData.filter((elm) => elm.cities.includes(activeItem))
    );
  }, [activeItem]);
      ...
      <div className="tf-container mb-5">
        <div className="heading-section text-center mb-48">
          <h2 className="title split-text effect-right">
            <SplitTextAnimation text="Featured Listing" />
          </h2>
        ...
        <div className="widget-tabs style-2 position-relative">
          <ul className="widget-menu-tab mb-48 overflow-x-auto">
            {items.map((item, index) => (
              <li
                key={index}
                className={`item-title whitespace-nowrap hover-tooltip ${
              ...
              >
                ...
                <span className="tooltip">
                  {
                    FeaturedListingData.filter((elm) =>
          ...
          <div className="widget-content-tab">
            <div className="widget-content-inner active">
              ...
              {/* Navigation buttons */}
              <div className="d-flex align-items-center gap-5 navigationPosition position-absolute top-0 right-0">
                <div className="swiper-button-prev position-relative p-2 rounded-5">
                  <FaChevronLeft className="i" />
                </div>
                <div className="swiper-button-next position-relative p-2 rounded-5">
