                  ...
                  <div className="widget-content-inner active fadeInTab">
                    <div className=" tf-grid-layout md-col-3 ">
                      <div className="icons-box default effec-icon ">
                        <div className="tf-icon d-flex gap-4 justify-content-between align-items-center">
                          <div className="">
                            <svg
                              width={80}
                              height={80}
                        ...
                        <div className="cardImage">
                          <img
                            className="rounded-4"
                            src="https://www.ellisandco.co.uk/wp-content/uploads/2024/05/BYM-How-much-can-I-afford-to-borrow.png"
                            alt=""
                          />
                        </div>

                        <p className="text-start text-1">
                      ...
                      <div className="icons-box default effec-icon ">
                        <div className="tf-icon d-flex gap-4 justify-content-between align-items-center">
                          ...
                          <div className="h-fit">
                            <h4 className="title titleC">
                              <a href="#">Understand your monthly costs</a>
                            </h4>
                          </div>
                        </div>
                        ...
                        <div className="cardImage">
                          <img
                            className="rounded-4"
                            src="https://thumbs.dreamstime.com/b/man-using-calculator-counting-budget-expenses-savings-man-using-calculator-counting-budget-expenses-savings-low-112833874.jpg"
                            alt=""
                          />
                        </div>
                      ...
                      <div className="icons-box default effec-icon ">
                        <div className="tf-icon d-flex gap-4 justify-content-between align-items-center">
                          ...
                          <div className="h-fit">
                            <h4 className="title titleC">
                              <a href="#">Get help with your down payment</a>
                            </h4>
                          </div>
                        </div>
                        ...
                        <div className="cardImage">
                          <img
                            className="rounded-4"
                            src="https://thumbs.dreamstime.com/b/down-payment-assistance-written-model-home-140950712.jpg"
                            alt=""
                          />
                        </div>
